...
const streaming_content_module_1 = require("./modules/streaming-content/streaming-content.module");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [streaming_content_entity_1.StreamingContent],
                synchronize: true,
            }),
            streaming_content_module_1.StreamingContentModule,
